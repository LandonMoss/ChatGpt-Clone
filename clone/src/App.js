...
function App() {
  ...
  const [messages, setMessages] = useState([
    {
      text:  "Hi, I'm ChatGPT, a state-of-the-art lanuguage model developed by OpenAI.",
      isBot: true,
  }
]);
  ...
  return (
    ...
    <div className="main">
      ...
      <div className="chatFooter">
        ...
        <p>ChatGTP may produce inaccurate information about people, places, or facts. ChatGPT August 20 Version.</p>
      </div>
      </div>
    </div>
  );
